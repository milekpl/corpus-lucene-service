...
This tool is inspired by [TMLookup](https://github.com/afarkas/tmlookup) by András Farkas, a beloved tool for translators. While TMLookup used SQLite for simplicity, this service leverages Apache Lucene to handle massive corpora with sub-millisecond query times and enterprise-grade reliability.
...
- **Morfologik** - Polish language morphological analysis
...
Inspired by [TMLookup](https://github.com/afarkas/tmlookup) by András Farkas - a simple but powerful tool that served the translation community for years.
